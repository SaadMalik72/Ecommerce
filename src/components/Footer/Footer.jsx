        ...
        <div className="container">
            <div className="grid md:grid-cols-3 pd-20 pt-5">
                ...
                <p className="text-gray-600 dark:text-white/70 lg:pr-24 pt-3">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias quia in aliquam earum facilis nemo deleniti perspiciatis numquam optio nostrum magnam, similique perferendis praesentium aspernatur ex, autem quibusdam accusamus unde.
                </p>
                <p className="text-gray-500 mt-4">
                    Made With Love by coding jounery 
                </p>
                <a href="https://www.youtube.com/@Cricket-Love_MS-Sky72"
                target="_blank"
                className="inline-block bg-primary text-white py-2  px-4 mt-4 text-sm rounded-full">
                    Visit Our Youtube Channal
                </a>
                </div>
                {/* Footer Links */}
