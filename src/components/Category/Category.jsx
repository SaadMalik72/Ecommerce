...
import Image1 from "/Created Website/ECommers in react.js/Ecommerce/src/assets/category/earphone.png";
import Image2 from "/Created Website/ECommers in react.js/Ecommerce/src/assets/category/watch.png";
import Image3 from "/Created Website/ECommers in react.js/Ecommerce/src/assets/category/macbook.png";
    ...
    <div className="py-8">
        <div className="container">
            <div className="grid grid-col-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                {/* Third Col */}
                <div className="sm:col-span-2 py-10 pl-5 bg-gradient-to-br from-primary to-primary/90 text-white rounded-3xl relative h-[350px] flex items-end">
                    <div>
                        <div className="mb-4">
                            <p className="mb-[2px] text-white">Enjoy</p>
                            <p className="text-2xl font-semibold mb-[2px]">With</p>
